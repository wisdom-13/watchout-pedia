...
import { AiOutlinePlusCircle, AiFillEye } from 'react-icons/ai';
...
const Backdrap = styled.div`
  display: flex;
  width: 100%;
  height: 394px;
  background-image: linear-gradient(-180deg, rgb(0, 0, 0, 0.35) 2%, rgba(0, 0, 0, 0.2) 70%, rgba(0, 0, 0, 0.5) 100%);
  overflow: hidden;
`;
